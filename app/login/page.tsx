...
export default function LoginPage() {
  ...
  const handleLogin = async (e: React.FormEvent) => {
    ...
    if (signInError) {
      // Try to detect if the email belongs to a Google-only account
      if (
        signInError.message === 'Invalid login credentials' ||
        signInError.message.toLowerCase().includes('invalid')
      ) {
        // Query the profiles table: if a profile exists, the user signed up via Google
        ...
        } else if (signInError.message.toLowerCase().includes('confirmed') || signInError.message.toLowerCase().includes('not confirmed')) {
          setError(
            'Your email is not confirmed yet. Please check your inbox (and spam) for a confirmation link.'
          );
        } else {
  ...
  return (
    <div className="min-h-screen w-full flex bg-[#f5f3e7] font-sans">
      ...
      <div className="hidden lg:flex flex-col relative w-[48%] xl:w-[45%] bg-zinc-900 flex-shrink-0 min-h-screen overflow-hidden">
        ...
        <div className="relative z-10 flex flex-col justify-between pt-16 pb-12 px-10 xl:px-14 text-white h-full w-full">
          ...
          <div className="mt-auto max-w-[360px] xl:max-w-[400px]">
            ...
            <h1
              className="text-[42px] xl:text-[50px] font-black leading-[1.05] uppercase tracking-widest mb-8 drop-shadow-2xl"
              style={{ fontFamily: 'Impact, sans-serif', wordSpacing: '0.15em' }}
            >
            ...
            <div className="backdrop-blur-xl bg-white/10 border border-white/20 p-6 rounded-2xl shadow-2xl relative overflow-hidden group hover:bg-white/15 transition-all duration-300">
              ...
              <p className="text-[14.5px] xl:text-[15.5px] font-medium leading-[1.7] text-gray-100 opacity-100 drop-shadow-md">
                ...
                <span className="text-white font-bold bg-white/20 px-1.5 py-0.5 rounded ml-0.5 shadow-sm">
                  Samsung Galaxy S24
                </span>{' '}
      ...
      <div className="flex-1 flex flex-col justify-center items-center py-12 px-6 lg:px-12 relative overflow-y-auto">
        ...
        <Link
          href="/"
          className="absolute top-6 left-6 md:top-10 md:left-10 flex items-center justify-center w-12 h-12 bg-white border border-gray-200 rounded-full text-gray-600 hover:text-[#2B3118] shadow-sm transition-colors z-20 hover-vibrate"
        >
        ...
        <div className="w-full max-w-[440px] flex flex-col my-auto">
          ...
          <h2
            className="text-[44px] md:text-[54px] font-black uppercase text-[#2B3118] tracking-widest text-center mb-10"
            style={{ fontFamily: 'Impact, sans-serif', wordSpacing: '0.15em' }}
          >
            WELCOME BACK.
          </h2>
          ...
          <div className="flex flex-col gap-3">
            ...
            <button
              ...
              className="flex items-center justify-center gap-3 w-full bg-white border border-gray-300 shadow-sm rounded-md py-3.5 px-4 hover:bg-gray-50 transition-colors font-bold text-[14.5px] text-gray-800"
            >
              <svg width="20" height="20" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 384 512" fill="currentColor">
                <path d="M318.7 268.7c-.2-36.7 16.4-64.4 50-84.8-18.8-26.9-47.2-41.7-84.1-44.6-35.9-2.8-74.3 22.7-93.1 22.7-18.9 0-51-22.9-80-22.9-42.3 0-82.6 24.2-104.9 63.8-45 80.3-15.1 199.1 28.8 261.3 21.6 30.7 47 62.4 80.7 61.2 32.3-1.2 44.8-21 82.2-21 37.4 0 48.6 21.1 82.7 20.4 35.1-.7 57.6-29.3 79-59.8 24.7-35.5 35.1-70 35.7-71.8-1.1-.4-66.9-25.2-67-104.5zM227.6 112.9c18.5-22.5 31.1-53.9 27.6-84.9-26.5 1.1-58.8 17.5-78 40.1-17.1 19.8-31.5 52.3-27.4 82.2 29.8 2.3 59.3-14.8 77.8-37.4z" />
              </svg>
              Continue with Apple
            </button>
          </div>
            ...
            <div className="flex flex-col gap-1.5 relative">
              <div className="flex items-center justify-between">
                ...
                <button
                  ...
                  className="text-[13px] font-bold text-gray-500 hover:text-[#2B3118] hover:underline underline-offset-4 decoration-gray-400 hover:decoration-[#2B3118] transition-colors disabled:opacity-50"
                >
          ...
          <div className="mt-8 flex justify-center border-t border-gray-200 pt-8">
            <p className="text-[15px] text-gray-600 font-medium flex items-center gap-1">
              ...
              <Link
                href="/signup"
                className="relative group inline-block font-black text-[#2B3118] hover:text-[#454c30] transition-colors ml-1"
              >
                Sign Up
